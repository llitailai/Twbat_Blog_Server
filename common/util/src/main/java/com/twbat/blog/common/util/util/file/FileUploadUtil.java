package com.twbat.blog.common.util.util.file;
...
import com.twbat.blog.common.util.util.exception.FileNameLengthLimitExceededException;
import com.twbat.blog.common.util.util.exception.FileSizeLimitExceededException;
import com.twbat.blog.common.util.util.exception.InvalidExtensionException;
...
public class FileUploadUtil {
    ...
    public static final String extractFilename(MultipartFile file) {
        ...
        fileName = DateUtils.datePath() + "/" + UUID.randomUUID() + "." + extension;
        return fileName;
    }
    ...
    public static final String getPathFileName(String uploadDir, String fileName) throws IOException {
        ...
        String pathFileName = Constant.RESOURCE_PREFIX.getCode() + "/" + currentDir + "/" + fileName;
        return pathFileName;
    }
